...
from keras.layers import Input, LSTM, Dense, Embedding, TimeDistributed, Dropout, BatchNormalization
...
#                        validation_split=0.2, callbacks=callback_list)
        ...
        basic_model.save_weights("P1.h5")
    ...
    def build_basic_inference_model(self):
        ...
        model.load_weights(file_path + "/P1.h5")
